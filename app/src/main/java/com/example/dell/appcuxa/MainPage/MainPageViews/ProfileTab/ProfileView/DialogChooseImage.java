...
public class DialogChooseImage extends BottomSheetDialogFragment implements View.OnClickListener{
    ...
    String token;
    DialogChooseImage.OnChooseReasonListener listener;
    ...
    public void setOnChooseReasonListener(DialogChooseImage.OnChooseReasonListener listener) {
